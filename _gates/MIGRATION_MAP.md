...
|---|---|---|---|---|
| 1 | `DESIGN_how_it_works.md` **CZ.I** | `L_npc/L*` | rozbić na warstwy L0-L5 (ETAP 2) | pending |
| 2 | `DESIGN_how_it_works.md` **CZ.II** | `C_world/C*` | rozbić na warstwy C0-C4 (ETAP 2) | pending |
| 3 | `HUNGER_design.md` | `L_npc/L1_hunger.md` | całość | pending |
| 4 | `APPETITE_GRUBAS_design.md` | `L_npc/L1_hunger.md` | scalić z HUNGER (grubas/appetite) | pending |
| 5 | `SLEEP_ENGINE_design.md` + `SLEEP_ENGINE_ETAP2_design.md` | `L_npc/L1_sleep.md` | oba etapy | pending |
| 6 | `AMBIENT_TEMP_design.md` | `C_world/C3_climate.md` (świat) **+** `L_npc/L1_temperature.md` (odczuwanie) | **aspekt przez interfejs** — świat vs odczuwanie | pending |
...
| 11 | `TECH-11_PERCEPTION_design.md` | `L_npc/L1_body_senses.md` + `L0_fight_or_flight.md` | percepcja jako jedna prawda | pending |
